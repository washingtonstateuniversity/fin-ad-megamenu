...
(function($){
    ...
    if( "undefined" !== window.jQuery.wsu || "undefined" !== window.jQuery.wsu.fais || "undefined" !== window.jQuery.wsu.fais.megamenu ){
        ...
        if(  (typeof(jQuery) === 'undefined' || (typeof($) === 'undefined' && typeof(jQuery) === 'undefined') ) ){
            // || (jQuery().jquery !== _jquery_version || jQuery.fn.jquery !== _jquery_version) ){
        ...
        if( 0 === $("link[href*='/resources/flexwork/"+dev+"flexwork-']").length && 0 === $("link[href*='/resources/flexwork/dev/flexwork-']").length ){
            css_dependants.push('https://webcore.fais.wsu.edu/resources/flexwork/'+dev+'flexwork-lite.css');
        }
        ...
        (function load_base() {
            loading = setTimeout(function(){
                if( (typeof(jQuery) === 'undefined' || (typeof($) === 'undefined' && typeof(jQuery) === 'undefined') || false ===css_loaded  ) ){
                    // || (jQuery().jquery !== _jquery_version || jQuery.fn.jquery !== _jquery_version) ){
                    window.clearTimeout(loading);
                    loading = null;
                    for ( var i = 0; i < css_dependants.length; i++ ) {
                        if ( 0 === $("link[href*='"+css_dependants[i]+"']").length  ) {
